...
public class ProductMasterDaoImpl implements ProductMasterDao {
	...
	public static final String INS_ITEM_QRY = "INSERT INTO productlist(id,productdesc,productname,cost) values(?,?,?,?)";
	public static final String UPD_ITEM_QRY = "UPDATE productlist SET productdesc=?,productname=?,cost=? WHERE id=?";
	public static final String DEL_ITEM_QRY = "DELETE FROM productlist WHERE id=?";
	public static final String SEL_ITEM_QRY_BY_ID = "SELECT id,productdesc,productname,cost FROM productlist WHERE id=?";
	public static final String SEL_ALL_ITEMS_QRY = "SELECT id,productdesc,productname,cost FROM productlist";
	...
	public List<ProductMaster> getAll() throws CoronaException {
		...
		try (Connection con = ConnectionFactory.getConnection();
			...
			throw new CoronaException("An error occured, Could not retrive the product details!");
		}
